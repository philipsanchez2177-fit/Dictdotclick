...
**Phase 0 complete.** The project file was authored directly rather than generated by Xcode's New
Project wizard, so Philip's steps are `git pull` and ⌘R (see `RUN-IT.md`). Verified on the Mac
2026-08-19: `BUILD SUCCEEDED`, app launches, mic icon in the menu bar. **Next: Phase 1.**
